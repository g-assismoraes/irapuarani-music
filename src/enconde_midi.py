# baseado em https://github.com/lucasnfe/music-sentneuron/blob/master/midi_encoder.py
...
def save_to_txt(encoded_midi, path):
    # Save the encoded MIDI representation as a .txt file
...
if __name__ == "__main__":
    ...
    _ , _ = load("data\midi", transpose_range=10, stretching_range=10)
